...
@lmp.register("multi-persistence-cnn")
class MultiPersistenceCNN(BaseModel):
    @dataclass
    ...
    def configure(self) -> None:
        ...
        assert not self.use_aux_mean_filt_act
    ...
    def forward(self, x: Float[Tensor, "B Cin *D"]) -> Float[Tensor, "B Dout"]:
        ...
        assert G.shape[2] == 1
        G: Float[Tensor, "B C0 *D"] = G.squeeze(2)
        ...
        aux_flat = None
        # TODO: Not implemented yet for this version
