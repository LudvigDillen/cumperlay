...
class CubicalComplex(nn.Module):
    ...
    def __init__(self, superlevel=False, dim: Optional[int] = None, calculate_gens: bool = True):
    ...
    def _forward(self, x: Float[Tensor, "*D"]):
    ...
    def _create_tensors_from_pairs(self, x: Tensor, pairs: Tensor, dim: int):
