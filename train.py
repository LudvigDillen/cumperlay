...
def main(args, extras) -> None:
    ...
    import lmp
    from lmp.trainers.base import BaseTrainer
    from lmp.util.callbacks import (
        CodeSnapshotCallback,
        ConfigSnapshotCallback,
        CustomProgressBar,
        ProgressCallback,
    )
    from lmp.util.config import ExperimentConfig, load_config
    from lmp.util.misc import get_rank
    from lmp.util.typing import Optional
